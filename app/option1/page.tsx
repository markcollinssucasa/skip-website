        ...
        <div className="section-shell">
          <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="space-y-3">
              ...
              <h2 className="font-display text-4xl tracking-[-0.02em] text-brand md:text-6xl">Lowest rate guarantee</h2>
              <p className="max-w-[58ch] text-base leading-relaxed text-ink/65 md:text-lg">
                Get pre-approved for a lower rate and we will match it and give you $10000 cashback.
              </p>
            </div>
        ...
        <div className="section-shell grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="max-w-[56ch] text-base leading-relaxed text-ink/70 md:text-lg">
              Skip is designed for borrowers who can service a loan but cannot hit a traditional deposit target.
            </p>
        ...
        <div className="section-shell">
          <div className="mb-10 grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            <div className="space-y-3">
              ...
              <h2 className="font-display text-4xl tracking-[-0.02em] text-brand md:text-6xl">Simple path, responsible lending</h2>
            </div>
            <p className="max-w-[50ch] text-base leading-relaxed text-ink/70 md:text-lg">
              Simple process with Australian based human support all the way through.
            </p>
          </div>
